...
Original file is located at
    https://colab.research.google.com/drive/18qVLEszDl4XnLGbVvsgtHnR4XhoAm2eR
"""
...
# 2. Define the path to the ZIP file in your Google Drive
zip_path = '/content/drive/MyDrive/dataset_new.zip'

# 3. Define the extraction path
extract_path = '/content/dataset_new'  # Extracts to Colab's working directory

# 4. Unzip the dataset if it's not already extracted
if not os.path.exists(extract_path):
    ...
    print(f"Dataset directory already exists at {extract_path}")

# 5. Account for the nested structure
nested_dir = os.path.join(extract_path, "dataset_new")
if os.path.exists(nested_dir):
    # Use the nested directory if it exists
    base_dir = nested_dir
else:
    # Fallback to the original path
    base_dir = extract_path

# 6. Define train and test directories
